...
//       isLoaded &&
//       !isSignedIn &&
//       !["javascript", "python", "java"].includes(language)
//     ) {
...
//                 // const isLocked =
//                 //   (!hasAccess && lang.isProReq == true)

//                 const isLocked =
//                   (!hasAccess && lang.isProReq) ||
//                   (!isSignedIn &&
//                     !["javascript", "python", "java"].includes(
//                       lang.id.toLowerCase()
//                     ));
...
function LanguageSelector({ hasAccess }: { hasAccess: boolean }) {
  ...
  }, [isLoaded, isSignedIn, language, setLanguage]);
  ...
  const handleLanguageSelect = (isProReq: boolean, langId: string) => {
    if (!hasAccess && isProReq) return; // Prevent selection of Pro-required languages without access
    setLanguage(langId);
    setIsOpen(false);
  };
